...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create reply' do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { description: @reply.description, ticket_id: @reply.ticket_id } }
    end
  ...
  test 'should update reply' do
    patch reply_url(@reply), params: { reply: { description: @reply.description, ticket_id: @reply.ticket_id } }
