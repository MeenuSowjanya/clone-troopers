...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post folders_url, params: { folder: { category_id: @folder.category_id, description: @folder.description, name: @folder.name } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { category_id: @folder.category_id, description: @folder.description, name: @folder.name } }
